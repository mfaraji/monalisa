...
from app import admin_mapping
from app.assets import assets
from app.auth import auth
from app.commands import create_db, drop_db, populate_db, recreate_db
from app.database import db
from app.extensions import lm, travis, mail, migrate, bcrypt, babel, rq, limiter, admin
from app.user import account
from app.report import report_b
...
def create_app(config=config.base_config):
    ...
    def index():
        ...
        return redirect(url_for('report_b.list'))
...
def register_blueprints(app):
    ...
    app.register_blueprint(report_b, url_prefix='/report')
